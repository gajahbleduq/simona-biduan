            ...
            <div class="col-12 text-center">
                <div class="d-flex justify-content-center align-items-center">
                    <ul class="nav nav-pills mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<?= site_url('accepted'); ?>">
                                <i data-feather="check" class="font-medium-3 me-50"></i>
                                <span class="fw-bold me-50">Diterima</span>
                                <span class="fw-bolder"><?= $count_accepted ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="card-body">
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="float-start mb-0">Daftar Tiket Diterima</h2>
                            </div>
                        </div>
                    </div>
                    <form action="<?= site_url('accepted'); ?>" method="POST">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center align-content-center gap-1">
                                            <?php if($this->user_level == 1 && $status == "2") { ?>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                <div class="text-center mb-2">
                    ...
                    <h4>No Ticket: <span id="spanNoTicket"></span></h4>
                </div>
                <div class="row">
                                ...
                                <div class="col-lg-6 col-xs-12" style="margin-bottom: 12px">
                                    ...
                                    <div class="d-flex flex-row meetings">
                                        ...
                                        <div class="content-body cursor-pointer" onclick="showModalAttachment()">
                                            ...
                                            <small><span id="spanJumlahAttachment"></span> Attachment</small>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <form id="formChangeStatus" class="row gy-1 formChangeStatus" method="POST"
                        ...
                        <input type="hidden" id="urlfrom" name="urlfrom" value="accepted" />
                        <input type="hidden" id="to" name="to" value="4" />
