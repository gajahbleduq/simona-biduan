...
<div class="app-content content">
    ...
    <div class="content-wrapper container-xxl p-0">
        <div class="content-header row">
                    ...
                    <div class="col-12">
                        ...
                        <div class="breadcrumb-wrapper">
                            <ol class="breadcrumb">
                                ...
                                <li class="breadcrumb-item"><a href="<?= site_url('all_tickets'); ?>">Semua Tiket </a>
                                </li>
			...
			if($this->user_level == 2 && $ticket['is_finished'] == 1 && sizeof($survey_answer_check) == 0) {
				$disabledButton = '';
			}?>
            <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-block">
                <div class="mb-1 breadcrumb-right">
                    <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#addSurvey"
                        <?=$disabledButton;?>>
                ...
                <div class="modal-dialog modal-lg modal-dialog-centered modal-edit-user">
                    <div class="modal-content">
                        ...
                        <div class="modal-body pb-5 px-sm-5 pt-50">
                            ...
                            <form action="<?= site_url('ticket/' . $ticket['no_ticket'] . '/survey/add') ?>"
                                ...
                                <div class="col-12 text-center mt-2 pt-50">
                                    <button type="submit" class="btn btn-primary me-1">Kirimkan</button>
