        ...
        <div class="content-header row">
            <div class="content-header-left col-md-9 col-12 mb-2">
                <div class="row breadcrumbs-top">
                    <div class="col-12">
                        <h2 class="content-header-title float-start mb-0">Tiket Diteruskan</h2>
        ...
        <div class="card">
            <div class="card-body">
                <div class="content-header row">
                    ...
                    <form action="<?= site_url('ins/followedup'); ?>" method="POST">
                            ...
                            <tbody>
                                ...
                                if (sizeof($data_reports)>0) {
                                    for ($i=0;$i<sizeof($data_reports);$i++) {
										...
										$followed_up_at = $data_reports[$i]["followed_up_at"];
										$accepted_at = $data_reports[$i]["accepted_at"];
                                ...
                                <tr>
                                    ...
                                    <td><?php if($followed_up_at == "") { echo "-"; } else { echo $this->general->datetime_indo($followed_up_at); } ?>
                                    </td>
                                    <td><?php if($accepted_at == "") { echo "-"; } else { echo $this->general->datetime_indo($accepted_at); } ?>
                                    </td>
                                    ...
                                    <td>
                                        <div class="d-flex justify-content-center align-content-center gap-1">
                                            ...
                                            <button class="btn btn-sm btn-warning rounded"
                                                ...
                                                data-bs-placement="top" title="Terima Terusan" data-id="<?=$id;?>"
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <div class="row">
                    ...
                    <form id="formChangeStatus" class="row gy-1 formChangeStatus" method="POST"
                        ...
                        <input type="hidden" id="urlfrom" name="urlfrom" value="ins/followedup" />
                        ...
                        <div class="col-12 text-center mt-2 pt-50">
                            <button type="button" onclick="submitform()" class="btn btn-primary me-1">Terima</button>
...
function submitform() {
    ...
    if (checkvalidity) {
        ...
        Swal.fire({
            ...
            text: 'Anda akan menerima tiket ini',
            icon: "question",
