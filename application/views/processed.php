            ...
            <div class="col-12 text-center">
                <div class="d-flex justify-content-center align-items-center">
                    <ul class="nav nav-pills mb-2">
                        ...
                        <li class="nav-item">
                            <a class="nav-link active" href="<?= site_url('processed'); ?>">
                                <i data-feather="clock" class="font-medium-3 me-50"></i>
                                <span class="fw-bold me-50">Diproses</span>
                                <span class="fw-bolder"><?= $count_processed ?></span>
                            </a>
                        </li>
                        <li class="nav-item">
            ...
            <div class="card-body">
                <div class="content-header row">
                    <div class="content-header-left col-md-9 col-12 mb-2">
                        <div class="row breadcrumbs-top">
                            <div class="col-12">
                                <h2 class="float-start mb-0">Daftar Tiket Diproses</h2>
                            </div>
                        </div>
                    </div>
                    <form action="<?= site_url('processed'); ?>" method="POST">
            ...
            <div class="modal-body pb-5 px-sm-5 pt-50">
                ...
                <div class="row">
                    ...
                    <form id="formChangeStatus" class="row gy-1 formChangeStatus" method="POST"
                        ...
                        <input type="hidden" id="urlfrom" name="urlfrom" value="processed" />
                        <input type="hidden" id="to" name="to" value="5" />
...
function showModalFinish(a) {
    ...
    Swal.fire({
        ...
        if (result.isConfirmed) {
            ...
            window.location.href = "<?= site_url('finish_ticket/')?>" + id + "/" + noTicket + "/processed";
